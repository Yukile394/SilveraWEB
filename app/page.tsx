      ...
      <main>
        <section className="shell hero">
          ...
          <div className="hero-copy">
            ...
            <h1>
              1 numaralı <em>Silvera</em> deneyimine katıl
            </h1>
            <p className="hero-sub">
              SVX (BoxPvP) modunda rütbeler, kitler ve daha fazlasıyla envanterini
              güçlendir. Satın al, oyuna dön — ürünün saniyeler içinde hesabına tanımlanır.
            </p>
            <div className="hero-actions">
              <a href="#vip-shop" className="btn-play">
                ▶ Şimdi Oyna
              </a>
            </div>
            ...
            <div className="play-panel">
              <div className="play-panel-text">
                <h3>Oyun zamanı!</h3>
                <p>
                  Silvera sunucusunda Minecraft deneyimini bir üst seviyeye taşı,
                  arkadaşlarınla birlikte keyfini çıkar.
                </p>
              </div>
